    ...
    */
    class TorrentView {
        ...
        public:
            ...
            int64_t get_download_speed();
            int64_t get_upload_speed();
        ...
        private:
            ...
            int64_t m_prev_download_speed = 0;
            int64_t m_prev_upload_speed = 0;
            int64_t m_prev_downloaded = 0;
            int64_t m_prev_uploaded = 0;
    };
